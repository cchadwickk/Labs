...
void addVar(char toAdd, char addTo, int prodNo){
    ...
    char str[10];
    int pos;
    cout<<"Addvar call with : "<<toAdd<<" "<<addTo<<" "<<prodNo<<endl;
    cout<<"\nFIRSTS:\n";
...
{
    cout<<"Addvars call with : "<<toAdd<<" "<<addTo<<" "<<prodNo<<endl;
...
void addVarFollow(const char toAdd, char addTo, int prodNo)
{
    ...
    char str[10];
    int i;
    cout<<"Addvarfollow call with : "<<toAdd<<" "<<addTo<<" "<<prodNo<<endl;
    cout<<"\n\nFOLLOWS:\n";
...
{
    cout<<"Addvarsfollow call with : "<<toAdd<<" "<<addTo<<" "<<prodNo<<endl;
    cout<<"\n\nFOLLOWS:\n";
    for(int i=0;i<foCnt;i++){
        cout<<"\n["<<follows[i][0]<<"]->{"<<&follows[i][1]<<"}"<<endl<<"Prod: ";
        for(int j=1;j<followProds[i].size();j++)
