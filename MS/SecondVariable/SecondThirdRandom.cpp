...
int main()
{
    ...
    float arvl[noOfCust], srvc[noOfCust+1], del[noOfCust], comp[noOfCust], time[noOfCust+1], total, avg_sum=0, avg_custWait=0, avg_timeUtil=0,lastEv = 0.0, sumCustWait = 0.0, timeUtil = 0.0;
